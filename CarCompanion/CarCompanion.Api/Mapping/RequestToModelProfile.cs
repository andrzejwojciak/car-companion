    ...
    public class RequestToModelProfile : Profile
    {
        public RequestToModelProfile()
        {
            ...
            CreateMap<PatchCarRequest, Car>()
                .ForMember(dest => dest.ProductionYear,
                    opt => opt.MapFrom((src, dest) =>
                        (src.ProductionYear == null ? dest.ProductionYear : src.ProductionYear)))
                .ForMember(dest => dest.Mileage,
                    opt => opt.MapFrom((src, dest) => (src.Mileage == null ? dest.Mileage : src.Mileage)))
            ...
            CreateMap<PatchExpenseRequest, Expense>()
                .ForMember(dest => dest.MileageInterval,
                    opt => opt.MapFrom((src, dest) =>
                        (src.MileageInterval == null ? dest.MileageInterval : src.MileageInterval)))
                .ForMember(dest => dest.Amount,
                    opt => opt.MapFrom((src, dest) => (src.Amount == null ? dest.Amount : src.Amount)))
                .ForMember(dest => dest.EndOfDateInterval,
                    opt => opt.MapFrom((src, dest) =>
                        (src.EndOfDateInterval == null ? dest.EndOfDateInterval : src.EndOfDateInterval)))
                .ForAllMembers(opts => opts.Condition((src, dest, srcMember, destMember) => srcMember != null));
